    ...
    return [
      ...
      <a-scene embedded arjs='sourceType: webcam; debugUIEnabled: false;'>
        ...
        <a-marker type='pattern' url='/assets/icon/gau.patt'>
          ...
          <a-image src="/assets/icon/adventurer.png" rotation='-90 0 0' scale="4 4 4" position='0 1.5 0'>
        ...
        <a-marker type='pattern' url='/assets/icon/rav.patt'>
          ...
          <a-image src="/assets/icon/advwhat.png" rotation='-90 0 0' scale="4 4 4" position='0 1.5 0'>
            <a-animation easing="linear" attribute="scale" dur="1000" to="2 2 1"></a-animation>
        ...
        <a-marker type='pattern' url='/assets/icon/raje.patt'>
          ...
          <a-image src="/assets/icon/advcurrent2.png" rotation='-90 0 0' scale="4 4 4" position='0 1.5 0'>
            <a-animation easing="linear" attribute="scale" dur="1000" to="2 2 1"></a-animation>
        ...
        <a-marker type='pattern' url='/assets/icon/edu.patt'>
          ...
          <a-image src="/assets/icon/advfuture.png" rotation='-90 0 0' scale="4 4 4" position='0 1.5 0'>
            <a-animation easing="linear" attribute="scale" dur="1000" to="2 2 1"></a-animation>
